...
//     setImmediate(() =>
//       console.log('[阶段3.immediate] 读文件回调2 增加的 immediate 回调4')
//     )
//   })
...
//     process.nextTick(() =>
//       console.log('[...待切入下一阶段] immediate 回调6 增加的 nextTick 回调7')
//     )
//     console.log('[...待切入下一阶段] 这块正在同步阻塞的读一个大文件')
//     // const video = readFileSync(resolve(__dirname, '../video.mp4'), 'utf-8')
//     process.nextTick(() =>
//       console.log('[...待切入下一阶段] immediate 回调6 增加的 nextTick 回调8')
//     )
...
//       setImmediate(() =>
//         console.log('[阶段3.immediate] 读文件回调3 增加的 immediate 回调6')
//       )
//       setTimeout(
//         () => console.log('[阶段1....定时器] 读文件回调3 增加的定时器回调8'),
//         0
//       )
//     })
//   })
